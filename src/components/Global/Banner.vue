    ...
    >
        <div ref="content" class="slider-content" :class="mask ? 'mask' : ''">
            <div
                ...
                :style="`background-image: url(${item.imageUrl});height: ${height}px;`"
            >
            ...
            <LeftCircleOutlined v-show="arrow" class="icon-left" @click="prev()"/>
            <RightCircleOutlined v-show="arrow" class="icon-right" @click="next()"/>
        </div>
